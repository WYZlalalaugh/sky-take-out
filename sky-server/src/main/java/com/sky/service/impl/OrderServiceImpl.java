...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        AddressBook address1 = addressBookMapper.getById(addressId);
        checkOutOfRange(address1.getProvinceName()+address1.getCityName()+address1.getDistrictName()+address1.getDetail());
        //向订单表插入一条数据
        ...
        String address=addressBookById.getProvinceName()+addressBookById.getCityName()+addressBookById.getDistrictName()+addressBookById.getDetail();
